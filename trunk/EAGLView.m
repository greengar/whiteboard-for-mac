...
- (BOOL) _createSurface
{
	...
	glGenRenderbuffersOES(1, &_renderbuffer); // creates a renderbuffer called _renderbuffer
...
- (void) _destroySurface
{
	...
	glDeleteRenderbuffersOES(1, &_renderbuffer); // destroy the renderbuffer we had created
	_renderbuffer = 0;
...
- (void) swapBuffers
{
	...
	glGetIntegerv(GL_RENDERBUFFER_BINDING_OES, (GLint *) &oldRenderbuffer);
	glBindRenderbufferOES(GL_RENDERBUFFER_OES, _renderbuffer); // Bind a renderbuffer (in this case, _renderbuffer)
