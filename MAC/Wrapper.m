...
//  WrapperTest
//
//  Created by Adrian on 10/18/08. Updated by Elliot in 2010.
...
- (void)postRequestToURLString:(NSString *)urlString withParameters:(NSDictionary *)parameters {
	DLog(@"postRequest...");
	[self sendRequestTo:[NSURL URLWithString:urlString] usingVerb:@"POST" withParameters:parameters];
}
...
- (void)uploadData:(NSData *)data toURL:(NSURL *)url
{
	...
	NSString *salt = @"QrSSpyZjjQu1HcEEhZ4bsvoVvq1A9IiOo2AJBfrJOh60mmCSQM5NOTXbGlqviG5";
...
- (void)connection:(NSURLConnection *)connection didReceiveAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge
{
    ...
    if (count == 0)
    {
		...
		// BUGFIX: Object sent -autorelease too many times
